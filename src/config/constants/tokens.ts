...
export const mainnetTokens = {
  ...
  bnb: new Token(MAINNET, '0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7', 18, 'AVAX', 'AVAX', 'https://www.avax.network/'),
  cake: new Token(
    MAINNET,
    '0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7',
    18,
...
export const testnetTokens = {
  ...
  busd: new Token(
    TESTNET,
    '0xD3cF37889Dc026216A9cde1E8d7796caceCc35CD',
    18,
    'BUSD',
    'Binance USD',
    'https://www.paxos.com/busd/',
...
export const serializeTokens = (): SerializedTokenList => {
  ...
  console.debug(unserializedTokens)
